...
public class Train {
	...
	public String toString() {
		return "Train [trainId=" + trainId + ", trainNo=" + trainNo + ", trainName=" + trainName + ", departs="
				+ departs + ", reach=" + reach + ", gen=" + gen + ", ac1=" + ac1 + ", ac2=" + ac2 + ", fc=" + fc
				+ ", slp=" + slp + ", dateOfTravel=" + dateOfTravel + "]";
	}
